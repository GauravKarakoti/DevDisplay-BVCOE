            ...
            <CardFooter className="flex flex-col items-center">
              ...
              <div className="flex mt-2">
                <a
                  ...
                  href="https://instagram.com/devdisplaybvcoe"
                  target="_blank"
                ...
                <a
                  rel="noreferrer noopener"
                  href="https://www.linkedin.com/company/devdisplay-bvcoe/"
                  target="_blank"
                  className={buttonVariants({
                    variant: "ghost",
                    size: "sm",
                ...
                <a
                  rel="noreferrer noopener"
                  href="https://twitter.com/devdisplaybvcoe"
                  target="_blank"
                  className={buttonVariants({
                    variant: "ghost",
                    size: "sm",
          ...
          <div className=" p-0 rounded-lg mt-2 text-center">
            <div className="flex flex-col gap-4 items-center justify-center">
              <div className="opacity-60 flex items-center">
                <a href="https://www.google.com/maps/search/?api=1&query=bharati+vidyapeeth's+college+of+engineering+new+delhi" target="_blank" rel="noopener noreferrer" className="hover:underline">View BVCOE Campus Community On Map</a>
              </div>
              <div className="opacity-60 flex items-center">
                <a href="mailto:devdisplay.bvcoe@gmail.com" className="hover:underline">Reach out us on - devdisplay.bvcoe@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
