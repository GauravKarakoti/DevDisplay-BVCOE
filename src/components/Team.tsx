...
const teamList: TeamProps[] = [
  {
    imageUrl: "/assets/team/Gaurav.jpg",
    name: "Gaurav Karakoti",
    position: "Community Leader / President",
    socialNetworks: [ 
      {
        name: "Instagram",
        url: "https://instagram.com/gaurav._.karakoti"
      },
      {
        name: "Linkedin",
        url: "https://linkedin.com/in/gaurav-karakoti"
      },
      {
        name: "X",
        url: "https://x.com/GauravKara_Koti",
      },
      {
        name: "Github",
        url: "https://github.com/GauravKarakoti",
      }
    ],
  },
  {
